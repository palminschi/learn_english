package com.palmdev.learn_english.Levels;
...
import com.palmdev.learn_english.AssetsUtil;
import com.palmdev.learn_english.LocaleHelper;
import com.palmdev.learn_english.MainActivity;
import com.palmdev.learn_english.R;
import com.palmdev.learn_english.Repeat;
...
import com.palmdev.learn_english.Shop;
...
public class Level1 extends AppCompatActivity {
    ...
    boolean showAds;
    public InterstitialAd interstitialAdTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_ads_off = findViewById(R.id.btn_ads_off);

        btn_ads_off.setVisibility(View.GONE);
    ...
    public void onClickAdsOff(View view){
        try {
            Intent intent = new Intent(Level1.this, Shop.class);
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        Level1.this.interstitialAd = interstitialAd;
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    @Override
                                    public void onAdDismissedFullScreenContent() {
                                        Level1.this.interstitialAd = null;
    ...
    public void loadInterstitialAdTwo() {
        AdRequest adRequest = new AdRequest.Builder().build();
        InterstitialAd.load(
                this,
                AD_UNIT_INTERSTITIAL_ID,
                ...
                new InterstitialAdLoadCallback() {
                    @Override
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        Level1.this.interstitialAdTwo = interstitialAd;
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    @Override
                                    public void onAdDismissedFullScreenContent() {
                                        Level1.this.interstitialAdTwo = null;
                                        Intent intent = new Intent(Level1.this, Repeat.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                    @Override
        ...
        btn_yes.setOnClickListener(v -> {
            try {
                if (interstitialAd != null) {
                    interstitialAd.show(Level1.this);
                } else {
                    Intent intent = new Intent(Level1.this, MainActivity.class);
                    startActivity(intent);
                    finish();
    ...
    private  void getDialogEnd(){
        ...
        btn_repeat.setOnClickListener(v -> {
            try {
                if (interstitialAdTwo != null) {
                    interstitialAdTwo.show(Level1.this);
                } else {
                    Intent intent = new Intent(Level1.this, MainActivity.class);
                    startActivity(intent);
                    finish();
    ...
    private void getContent(){
        ...
        switch (count) {
            case 4: case 5: case 10: case 13: case 15: case 18:
    ...
    private void saveData(){
        ...
        int words = save.getInt(getString(R.string.wordsLearned),0);
        if (completedLevels == 0) {
            editor.putInt(getString(R.string.completedLevels), 1);
            editor.apply();
            words += 20;
            editor.putInt(getString(R.string.wordsLearned), words);
            editor.apply();
        }
    }
