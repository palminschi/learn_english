...
public class Level12 extends AppCompatActivity {
    ...
    public void onClickAdsOff(View view){
        try {
            Intent intent = new Intent(Level12.this, Shop.class);
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        Level12.this.interstitialAd = interstitialAd;
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    @Override
                                    public void onAdDismissedFullScreenContent() {
                                        Level12.this.interstitialAd = null;
                                        Intent intent = new Intent(Level12.this, MainActivity.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                    @Override
        ...
        btn_yes.setOnClickListener(v -> {
            try {
                if (interstitialAd != null) {
                    interstitialAd.show(Level12.this);
                } else {
                    Intent intent = new Intent(Level12.this, MainActivity.class);
                    startActivity(intent);
                    finish();
    ...
    private  void getDialogEnd(){
        ...
        btn_repeat.setOnClickListener(v -> {
            try {
                Intent intent = new Intent(Level12.this, Repeat.class);
                startActivity(intent);
                finish();
            }catch (Exception e){
                //
    ...
    private void saveData(){
        ...
        if (completedLevels == 11) {
            editor.putInt("completedLevels", 12);
            editor.apply();
            words += 20;
