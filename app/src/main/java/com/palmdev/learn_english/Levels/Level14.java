...
public class Level14 extends AppCompatActivity {
    ...
    public void onClickAdsOff(View view){
        try {
            Intent intent = new Intent(Level14.this, Shop.class);
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        Level14.this.interstitialAd = interstitialAd;
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    @Override
                                    public void onAdDismissedFullScreenContent() {
                                        Level14.this.interstitialAd = null;
                                        Intent intent = new Intent(Level14.this, MainActivity.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                    @Override
        ...
        btn_yes.setOnClickListener(v -> {
            try {
                if (interstitialAd != null) {
                    interstitialAd.show(Level14.this);
                } else {
                    Intent intent = new Intent(Level14.this, MainActivity.class);
                    startActivity(intent);
                    finish();
    ...
    private  void getDialogEnd(){
        ...
        btn_repeat.setOnClickListener(v -> {
            try {
                Intent intent = new Intent(Level14.this, Repeat.class);
                startActivity(intent);
                finish();
            }catch (Exception e){
                //
    ...
    private void getContent(){
        ...
        switch (count) {
            case 2: case 6: case 10: case 16: case 17:
    ...
    private void saveData(){
        ...
        if (completedLevels == 13) {
            editor.putInt("completedLevels", 14);
            editor.apply();
            words += 20;
