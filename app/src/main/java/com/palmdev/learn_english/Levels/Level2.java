...
import com.palmdev.learn_english.SelectDayActivity;
...
public class Level2 extends AppCompatActivity {
    ...
    public void onClickAdsOff(View view){
        try {
            Intent intent = new Intent(Level2.this, Shop.class);
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        Level2.this.interstitialAd = interstitialAd;
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    @Override
                                    public void onAdDismissedFullScreenContent() {
                                        Level2.this.interstitialAd = null;
    ...
    public void loadInterstitialAdTwo() {
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    @Override
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        Level2.this.interstitialAdTwo = interstitialAd;
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    @Override
                                    public void onAdDismissedFullScreenContent() {
                                        Level2.this.interstitialAdTwo = null;
                                        Intent intent = new Intent(Level2.this, Repeat.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                    @Override
        ...
        btn_yes.setOnClickListener(v -> {
            try {
                if (interstitialAd != null) {
                    interstitialAd.show(Level2.this);
                } else {
                    Intent intent = new Intent(Level2.this, MainActivity.class);
                    startActivity(intent);
                    finish();
        ...
        btn_repeat.setOnClickListener(v -> {
            try {
                if (interstitialAdTwo != null) {
                    interstitialAdTwo.show(Level2.this);
                } else {
                    Intent intent = new Intent(Level2.this, Repeat.class);
                    startActivity(intent);
                    finish();
    ...
    private void saveData(){
        ...
        if (completedLevels == 1) {
            editor.putInt("completedLevels", 2);
            editor.apply();
            words += 20;
