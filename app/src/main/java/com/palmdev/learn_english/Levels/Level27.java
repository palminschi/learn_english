...
public class Level27 extends AppCompatActivity {
    ...
    public void onClickAdsOff(View view){
        try {
            Intent intent = new Intent(Level27.this, Shop.class);
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        Level27.this.interstitialAd = interstitialAd;
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    @Override
                                    public void onAdDismissedFullScreenContent() {
                                        Level27.this.interstitialAd = null;
                                        Intent intent = new Intent(Level27.this, MainActivity.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                    @Override
        ...
        btn_yes.setOnClickListener(v -> {
            try {
                if (interstitialAd != null) {
                    interstitialAd.show(Level27.this);
                } else {
                    Intent intent = new Intent(Level27.this, MainActivity.class);
                    startActivity(intent);
                    finish();
    ...
    private  void getDialogEnd(){
        ...
        btn_repeat.setOnClickListener(v -> {
            try {
                Intent intent = new Intent(Level27.this, Repeat.class);
                startActivity(intent);
                finish();
            }catch (Exception e){
                //
    ...
    private void getContent(){
        ...
        switch (count) {
            case 0:case 1:case 3: case 6: case 7: case 8: case 9: case 10: case 12: case 14: case 15: case 17: case 18: case 19:
    ...
    private void saveData(){
        ...
        if (completedLevels == 26) {
            editor.putInt("completedLevels", 27);
            editor.apply();
            words += 20;
