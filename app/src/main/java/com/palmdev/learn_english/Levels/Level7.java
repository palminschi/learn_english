...
public class Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor = save.edit();
        boolean soundValue = save.getBoolean("soundValue",false);
    ...
    public void onClickAdsOff(View view){
        try {
            Intent intent = new Intent(Level7.this, Shop.class);
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        Level7.this.interstitialAd = interstitialAd;
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    @Override
                                    public void onAdDismissedFullScreenContent() {
                                        Level7.this.interstitialAd = null;
        ...
        btn_yes.setOnClickListener(v -> {
            try {
                if (interstitialAd != null) {
                    interstitialAd.show(Level7.this);
                } else {
                    Intent intent = new Intent(Level7.this, MainActivity.class);
                    startActivity(intent);
                    finish();
    ...
    private  void getDialogEnd(){
        ...
        btn_repeat.setOnClickListener(v -> {
            try {
                Intent intent = new Intent(Level7.this, Repeat.class);
                startActivity(intent);
                finish();
            }catch (Exception e){
                //
    ...
    private void saveData(){
        ...
        if (completedLevels == 6) {
            editor.putInt("completedLevels", 7);
            editor.apply();
            words += 20;
