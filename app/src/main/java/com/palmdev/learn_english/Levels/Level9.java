...
public class Level9 extends AppCompatActivity {
    ...
    public void onClickAdsOff(View view){
        try {
            Intent intent = new Intent(Level9.this, Shop.class);
                        ...
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    ...
                                    public void onAdDismissedFullScreenContent() {
                                        ...
                                        Intent intent = new Intent(Level9.this, MainActivity.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                    @Override
        ...
        btn_yes.setOnClickListener(v -> {
            try {
                if (interstitialAd != null) {
                    interstitialAd.show(Level9.this);
                } else {
                    Intent intent = new Intent(Level9.this, MainActivity.class);
                    startActivity(intent);
                    finish();
    ...
    private  void getDialogEnd(){
        ...
        btn_repeat.setOnClickListener(v -> {
            try {
                Intent intent = new Intent(Level9.this, Repeat.class);
                startActivity(intent);
                finish();
            }catch (Exception e){
                //
    ...
    private void getContent(){
        ...
        switch (count) {
            case 1: case 5: case 7: case 8: case 16: case 17: case 18: case 19:
    ...
    private void saveData(){
        ...
        if (completedLevels == 8) {
            editor.putInt("completedLevels", 9);
            editor.apply();
            words += 20;
